...
def installer():
    ...
    if platform.system() == "Darwin":
        ...
        # Fixes a bug in UE4
        bug_path = os.path.join(unreal_directory, r"Engine/Source/Programs/UnrealBuildTool/Platform/Mac/MacToolChain.cs")
        ...
        blocks_directory = os.path.join(airsim_directory + r"Unreal/Environments/Blocks")
    ...
    if platform.system() == "Windows":
        ...
        # Runs stuff
        blocks_directory = os.path.join(os.getcwd() + r"Unreal/Environments/Blocks")
        os.chdir(blocks_directory)
